...
export default function Nav() {
    ...
    <a href="#hero" className="text-sm lg:text-base xl:text-xl text-cyan-400">Home</a>
   ...
   <a 
      ...
      className="bg-cyan-300 text-black px-3 py-1.5 lg:px-4 lg:py-2 rounded-lg shadow hover:brightness-95 text-sm lg:text-base"
    >
       Mon CV
    </a>
    </nav>
  ...
  <a 
      ...
      rel="noopener noreferrer"
      download="CV-Pascal-Akoudo-WordPress-Developer.pdf"
      className="bg-cyan-300 text-black px-2.5 py-1.5 sm:px-3 sm:py-2 rounded-lg text-sm sm:text-base"
    >
      Mon CV
    </a>
    </div>
