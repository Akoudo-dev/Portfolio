            ...
            {/* Navigation */}
             <nav className="px-4 sm:px-6 md:px-8 mt-6 sm:mt-0">
              ...
              <ul className="space-y-1.5 sm:space-y-2 text-gray-400 text-xs sm:text-sm">
                <li><a href="#hero" className="hover:text-[#0f4cf7] cursor-pointer transition-colors">Accueil</a></li>
                <li><a href="#projects" className="hover:text-[#0f4cf7] cursor-pointer transition-colors">Mes projets</a></li>
                <li><a href="#about" className="hover:text-[#0f4cf7] cursor-pointer transition-colors">À propos</a></li>
                <li><a href="#contact" className="hover:text-[#0f4cf7] cursor-pointer transition-colors">Me contacter</a></li>
              </ul>
            </nav>
        ...
        {/* Footer bottom */}
         <div className="mt-8 sm:mt-10 border-t border-gray-800 pt-3 sm:pt-4 text-center text-xs sm:text-sm text-gray-500">
          ...
          <p className="mt-2 text-xs">
            Conçu avec Coeur à Cotonou • <a href="#contact" className="text-[#0f4cf7] hover:underline">Discutons de votre projet</a>
          </p>
        </div>
